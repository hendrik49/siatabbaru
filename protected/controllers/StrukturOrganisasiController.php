...
class StrukturOrganisasiController extends Controller
{
	...
	public function actionLink($id)
	{
		$model = $this->loadModel($id);
			...
			if ($model->Link) {
				$data = file_get_contents(Yii::app()->params->baseMapPath . "/images/StrukturOrganisasi/" . $model->Link);
	...
	function forceDownload($filename = '', $data = '')
	{
		...
		// Generate the server StrukturOrganisasis
	...
	public function actionAdd()
	{
		...
		if(isset($_POST['StrukturOrganisasi']))
		{
			$model->attributes=$_POST['StrukturOrganisasi'];
	...
	{
		$model=new StrukturOrganisasi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StrukturOrganisasi']))
			$model->attributes=$_GET['StrukturOrganisasi'];
	...
	{
		$model=StrukturOrganisasi::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='StrukturOrganisasi-form')
		{
