...
class PPKController extends Controller
{
	...
	public function actionFoto($id)
	{
		$model = $this->loadModel($id);
			...
			if ($model->Foto) {
				$data = file_get_contents(Yii::app()->params->baseMapPath . "/PPK/" . $model->Foto);
	...
	public function actionAdd()
	{
		...
		if(isset($_POST['PPK']))
		{
			...
			if($model->save()) {
				...
				$model->Foto->saveAs($this->_mapPath . '/PPK/'. $model->Foto->getName());
	...
	public function actionIndex()
	{
		...
		//if (isset(Yii::app()->user->hakAkses) AND Yii::app()->user->hakAkses == User::USER_ADMIN)
		//	$urlFoto->compare('Foto', Yii::app()->request->baseUrl . "data/PPK" . $model->Foto);
		$dataProvider=new CActiveDataProvider('PPK');	
