...
class ManfaatPermukaan extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('status_airbaku, tadah_awal, tadah_saatini, suplesi_awal, suplesi_saatini, kecamatan1, kecamatan2, desa1, desa2, lebar_sungai', 'length', 'max'=>300),
	...
	public function relations()
	{
		...
		return array(
			...
			'permukaan'=>array(self::BELONGS_TO, 'Permukaan', 'ID_IDBalaiWa'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'lebar_sungai' => 'Lebar Sungai di Intake (m)',
	...
	public static function getNoDataByAdmin()
	{
		if (isset(Yii::app()->user->uid)) {
			$id = Yii::app()->user->uid;
			$command = Yii::app()->db->createCommand("SELECT * FROM t_permukaan2 WHERE ID_IDBalaiWa='$id'");
