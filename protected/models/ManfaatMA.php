...
class ManfaatMA extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('tadah_awal, tadah_saatini, suplesi_awal, suplesi_saatini, kecamatan1, kecamatan2, desa1, desa2', 'length', 'max'=>100),
	...
	public function relations()
	{
		...
		return array(
			...
			'mataair'=>array(self::BELONGS_TO, 'MataAir', 'ID_IDBalaiWa'),
	...
	public static function getNoDataByAdmin()
	{
		if (isset(Yii::app()->user->uid)) {
			$id = Yii::app()->user->uid;
			$command = Yii::app()->db->createCommand("SELECT * FROM t_mataair2 WHERE ID_IDBalaiWa='$id'");
