...
class InfoTampungan extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('foto1, foto2, foto3, foto4, foto5', 'file',
			'types'=>array('jpg', 'jpeg', 'gif', 'png', 'bmp'), 'allowEmpty'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'tampungan'=>array(self::BELONGS_TO, 'Tampungan', 'ID_IDBalaiJu'),
			'manfaat'=>array(self::BELONGS_TO, 'ManfaatTampungan', 'ID_IDBalaiJu'),
			'teknissat'=>array(self::BELONGS_TO, 'TeknisTampungan', 'ID_IDBalaiJu'),
			'teknisdua'=>array(self::BELONGS_TO, 'TeknisWaTampungan', 'ID_IDBalaiJu'),
			'teknisga'=>array(self::BELONGS_TO, 'TeknisGaTampungan', 'ID_IDBalaiJu'),
			'kondisi'=>array(self::BELONGS_TO, 'KondisiTampungan', 'ID_IDBalaiJu'),
		);
	}
