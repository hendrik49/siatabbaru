...
class Permukaan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('provinsi, kota, kecamatan, desa, nama_sistem, kodefikasi ', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'madasar'=>array(self::BELONGS_TO, 'Permukaan', 'ID_IDBalai'),
			'manfaat'=>array(self::BELONGS_TO, 'ManfaatPermukaan', 'ID_IDBalai'),
			'teknissat'=>array(self::BELONGS_TO, 'TeknisPermukaan', 'ID_IDBalai'),
			'teknisdua'=>array(self::BELONGS_TO, 'TeknisWaPermukaan', 'ID_IDBalai'),
		);
	}
