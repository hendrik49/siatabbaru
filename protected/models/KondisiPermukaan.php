...
class KondisiPermukaan extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'permukaan'=>array(self::BELONGS_TO, 'Permukaan', 'ID_IDBalaiNam'),
			'manfaat'=>array(self::BELONGS_TO, 'ManfaatPermukaan', 'ID_IDBalaiNam'),
			'teknissat'=>array(self::BELONGS_TO, 'TeknisPermukaan', 'ID_IDBalaiNam'),
			'teknisdua'=>array(self::BELONGS_TO, 'TeknisWaPermukaan', 'ID_IDBalaiNam'),
			'teknisga'=>array(self::BELONGS_TO, 'TeknisGaPermukaan', 'ID_IDBalaiNam'),
		);
	}
	...
	public static function getNoDataByAdmin()
	{
		if (isset(Yii::app()->user->uid)) {
			$id = Yii::app()->user->uid;
			$command = Yii::app()->db->createCommand("SELECT * FROM t_permukaan6 WHERE ID_IDBalaiNam='$id'");
