...
class Berita extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NamaBerita, status, Tanggal, Link', 'required'),
			...
			array('Kategori, NamaBerita, status, Link', 'length', 'max'=>255),
			array('status', 'length', 'max'=>2),
			array('ID, Kategori, NamaBerita, status, Tanggal, Link, Deskripsi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NamaBerita',$this->NamaBerita,true);
