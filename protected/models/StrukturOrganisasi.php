...
class StrukturOrganisasi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NamaJabatan, status, Tanggal, Link', 'required'),
			...
			array('Nama, NamaJabatan, status, Link', 'length', 'max'=>255),
			array('status', 'length', 'max'=>2),
			array('ID, Nama, NamaJabatan, status, Tanggal, Link, Deskripsi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NamaJabatan',$this->NamaJabatan,true);
