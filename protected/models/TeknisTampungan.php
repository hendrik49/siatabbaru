...
class TeknisTampungan extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'tampungan'=>array(self::BELONGS_TO, 'Tampungan', 'ID_IDBalaiGa'),
			'manfaat'=>array(self::BELONGS_TO, 'ManfaatTampungan', 'ID_IDBalaiGa'),
			'teknissat'=>array(self::BELONGS_TO, 'TeknisTampungan', 'ID_IDBalaiGa'),
		);
	}
	...
	public static function getNoDataByAdmin()
	{
		if (isset(Yii::app()->user->uid)) {
			$id = Yii::app()->user->uid;
			$command = Yii::app()->db->createCommand("SELECT * FROM t_tampungan3 WHERE ID_IDBalaiGa='$id'");
