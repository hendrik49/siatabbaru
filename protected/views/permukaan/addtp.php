...
<tr><td colspan="4"><?php 
	...
	if (isset(Yii::app()->user->hakAkses) AND (Yii::app()->user->hakAkses == User::USER_SUPER_ADMIN OR Yii::app()->user->hakAkses == User::USER_ADMIN)) : 
		...
		if($model->NoDataNam == TeknisWaPermukaan::getNoDataByAdmin()){
			$model->NoDataNam = TeknisWaPermukaan::getNoDataByAdmin();
		}
		else{
			$model->NoDataNam = TeknisGaPermukaan::getAvailableNoData();
		}
