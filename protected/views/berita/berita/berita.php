...
<h2 class="h-view"><?php if (isset(Yii::app()->user->hakAkses) AND (Yii::app()->user->hakAkses == User::USER_SUPER_ADMIN OR Yii::app()->user->hakAkses == User::USER_ADMIN)) : ?>Berita | <?php echo CHtml::link('Kelola berita', array('berita/')); ?><?php endif ?></h2>
		...
		<section>
			...
			<div id="berita">
				<?php $no = 1; 
					...
					$get = "select * from t_berita order by ID desc"; // ambil berita dari table berita dan diurutkan dari berita terbaru
