...
<td>
	...
	<?php echo $form->dropDownListRow($model,'provinsi', CHtml::listData(Provinsi::model()->findAll(),'Nama_provinsi','Nama_provinsi'),
		...
		'value'=>'0',
		'ajax' => array('type'=>'POST', 'url'=>CController::createUrl('Tampungan/setKot'), // panggi filter kabupaten di controller
		'update'=>'#Tampungan_kota', //selector to update
