...
<h2 class="h-view"><?php if (isset(Yii::app()->user->hakAkses) AND (Yii::app()->user->hakAkses == User::USER_SUPER_ADMIN OR Yii::app()->user->hakAkses == User::USER_ADMIN)) : ?>StrukturOrganisasi | <?php echo CHtml::link('Kelola StrukturOrganisasi', array('StrukturOrganisasi/')); ?><?php endif ?></h2>
