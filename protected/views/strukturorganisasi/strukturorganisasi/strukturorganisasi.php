...
<h2 class="h-view"><?php if (isset(Yii::app()->user->hakAkses) AND (Yii::app()->user->hakAkses == User::USER_SUPER_ADMIN OR Yii::app()->user->hakAkses == User::USER_ADMIN)) : ?>StrukturOrganisasi | <?php echo CHtml::link('Kelola Struktur Organisasi', array('StrukturOrganisasi/')); ?><?php endif ?></h2>
		...
		<section>
			...
			<div id="StrukturOrganisasi">
				<?php $no = 1; 
					...
					$get = "select * from t_StrukturOrganisasi order by ID desc"; // ambil StrukturOrganisasi dari table StrukturOrganisasi dan diurutkan dari StrukturOrganisasi terbaru
