...
<h2 class="h-view"><?php if (isset(Yii::app()->user->hakAkses) AND (Yii::app()->user->hakAkses == User::USER_SUPER_ADMIN OR Yii::app()->user->hakAkses == User::USER_ADMIN)) : ?>Peraturan | <?php echo CHtml::link('Kelola Peraturan', array('Peraturan/')); ?><?php endif ?></h2>
		...
		<section>
			...
			<div id="Peraturan">
				<?php $no = 1; 
					...
					$get = "select * from t_Peraturan order by ID desc"; // ambil Peraturan dari table Peraturan dan diurutkan dari Peraturan terbaru
